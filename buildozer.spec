...
# (list) Permissions
android.permissions =CAMERA,READ_CALL_LOG,READ_SMS,READ_PHONE_STATE,INTERNET,ACCESS_NETWORK_STATE,FOREGROUND_SERVICE,RECEIVE_BOOT_COMPLETED,POST_NOTIFICATIONS,WAKE_LOCK
